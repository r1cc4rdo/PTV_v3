...
A more detailed description of the relation between stops, directions and routes can be found in [here](https://github.com/r1cc4rdo/PTV_v3/blob/main/web/db/utils.py#L34).
